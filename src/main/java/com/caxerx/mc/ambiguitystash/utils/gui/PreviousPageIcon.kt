 ...
 */
class PreviousPageIcon(var material: Material, var data: Short?, var displayName: String?, var lore: ArrayList<String>?) : ToolbarIcon {
    ...
    override fun onClick(e: InventoryClickEvent) {
        StashManager.instance.getPlayer(e.whoClicked as Player).stashSession!!.openPreviousPage()
    }
}
